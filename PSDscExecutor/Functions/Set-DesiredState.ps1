<#
    .SYNOPSIS
        Invoke the set method on the specified configuration to apply the
        desired state once for every resource on the target system.
    ...
    .EXAMPLE
        PS C:\> Set-DesiredState -ConfigurationName 'WebServer'
        Set the configuration WebServer on the local system.
