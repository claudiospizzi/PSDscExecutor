<#
    .SYNOPSIS
        Invoke the get method on the specified configuration to return the
    ...
    .EXAMPLE
        PS C:\> Get-DesiredState -ConfigurationName 'WebServer'
        Get the configuration WebServer on the local system.
